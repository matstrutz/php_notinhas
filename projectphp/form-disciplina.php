...
<form method="post" action="http://localhost/projetodavid/db-disciplina.php?acao=<?=$action?>">
    <input type="hidden" id="id" name="id" value="<?=$id?>">
    
    <div class="container container-fluid">
        <h2 class="text-center mt-3"><?=$label?> disciplina</h2>
        <div class="row mt-3">
    ...
    <div class="container col-row-12">
        <a href="list-disciplina.php" class="btn btn-outline-danger mt-3" role="button">
